...
<html lang="en">
<head>
    <title>Code coverage report for src/flash-messages/flash-messages.component.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/flash-messages</a> flash-messages.component.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
  constructor(private flashMessagesService: FlashMessagesService<span class="branch-1 cbranch-no" title="branch not covered" >) { }</span>
&nbsp;
  ngOnInit() {
